...
from recipe.views import IngredientAutocomplete, IngredientSearchView

urlpatterns = [
    path('admin/', admin.site.urls),
    path('', IngredientSearchView.as_view(), name='ingredient-search'),
    path('home', IngredientSearchView.as_view(), name='ingredient-search'),
